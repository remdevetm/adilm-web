...
// Images
import img13 from "@/public/images/service/img13.jpg";
    ...
    <section className="service-details pos-rel">
      <div className="container">
        ...
        <div className="single-item-image service-det-img mb-75">
          <Image src={img13} alt="service-img" className="w-100" />
        ...
        <h2 className="details-content-title mb-15">
          Retrieval and grounding services for answers.
        </h2>

        <p>
          Unlock the true value of your knowledge with our comprehensive
          RAG-driven retrieval and grounding service. We help teams collect,
          structure, and index trusted content across systems for precise
          responses …
        </p>

        <p className="mt-30">
          We turn scattered information into confident, cited answers…
        </p>

        {/* === FAQ === */}
        <ServiceFaq />

        {/* === Service Outcome (Eco card) === */}
        <div className="services-outcome-wrap eco-card mt-60">
          <h2 className="details-content-title mb-15">Services outcome</h2>
          <p>
            We help high-growth teams accelerate delivery through
            production-grade retrieval and grounded generation …
          </p>

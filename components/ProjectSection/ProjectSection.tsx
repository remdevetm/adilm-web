  ...
  const projects = [
    {
      ...
      desc: "An end-to-end support agent that chats with customers, logs tickets into the helpdesk, checks billing, reminds users to update payments, verifies receipts, and reinstates accounts automatically once cleared.",
    ...
    },
    {
      ...
      desc: "A proposal-writing agent that turns sales conversations into polished, tailored proposals. It maps customer needs to your catalog, drafts scope and pricing language, and outputs ready-to-send documents fast.",
    ...
    },
    {
      ...
      desc: "AI agents for auditors that ingest semi‑structured and structured data, trace anomalies, generate evidence trails, and auto‑populate audit templates. They summarize risk areas and support deep, repeatable reviews.",
    ...
    <section className="project bg_img pt-135 pb-150">
      <div className="container">
        <div className="sec-title custom-sec-title xb-sec-padding text-center">
          <span className="sub-title">AI agents</span>
